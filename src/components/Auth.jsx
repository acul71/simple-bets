...
export const Auth = () => {
  ...
  return (
    <Stack spacing={6}>
      ...
      <Image boxSize="15px" src="img/logo.jpg" alt="Simple Bets Logo"/>
      <Button isLoading={isAuthenticating} onClick={ () => authenticate({ signingMessage: "Simple Bets Authentication" }) }>
